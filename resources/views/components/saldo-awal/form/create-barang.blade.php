            ...
            <div class="col-md-12 col-12">
                <div class="form-group">
                    ...
                    <input type="text" id="nama_satuan"
                        placeholder="Pilih {{ $jenis }} untuk melihat satuan." class="form-control" readonly>
                </div>
            </div>
            <div class="col-md-12 col-12">
                <div class="form-group">
                    ...
                    <input type="text" id="jenis_barang"
                        placeholder="Pilih {{ $jenis }} untuk melihat jenis." class="form-control" readonly>
                </div>
            </div>
            <div class="col-md-12 col-12">
                <div class="form-group">
                    <label for="nama_unit" class="text-primary">Unit</label>
                    <input type="text" id="nama_unit" placeholder="Pilih {{ $jenis }} untuk melihat unit."
            ...
            @if ($jenis === 'inventaris')
                <div class="col-md-12 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Masukkan harga beli {{ $jenis }}." id="nilai_buku"
                            class="form-control format-rupiah">
                    </div>
                </div>
            @endif
...
@section('pageScript')
    ...
    @if ($jenis === 'inventaris')
        <script src="{{ asset('assets/admin') }}/js/siakku-custom/create-inventaris.js"></script>
    @else
        <script src="{{ asset('assets/admin') }}/js/siakku-custom/create-persediaan.js"></script>
    @endif
@endsection
