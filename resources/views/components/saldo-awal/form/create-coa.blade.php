                                            ...
                                            @if ($data->kategori == $k->nama)
                                                <tbody>
                                                    <input type="hidden" class="form-control"
                                                        name="id_coa{{ $data->id_coa }}" value="{{ $data->id_coa }}"
                                                        readonly>
                                                    <input type="hidden" class="form-control"
                                                        name="header{{ $data->id_coa }}" value="{{ $data->header }}"
                                                        readonly>
                                                    <tr>
    ...
    <div class="col-12">
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td style="text-align:right" id="total_debet">
                </td>
                <td style="text-align:right" id="total_kredit"></td>
            </tr>
        </table>
        <input type="hidden" class="form-control" id="input_total_debet" name="total_debet" readonly>
        <input type="hidden" class="form-control" id="input_total_kredit" name="total_kredit" readonly>
    </div>
</div>
<div class="row">
