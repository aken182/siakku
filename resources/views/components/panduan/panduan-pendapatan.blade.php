<div class="collapse" id="collapseExample">
    ...
    <div class="d-grid p-3 border">
        <ol class="text-dark">
            <li>Pilih jenis pendapatan pada field "<b>Jenis Pendapatan</b>". Terdapat
                ...
                "<b>Pendapatan Baru</b>". Bila anda ingin merubah transaksi yang sudah ada
                dan yang didalamnya terdapat kesalahan input atau kesalahan lainnya maka pilih
                "<b>Penyesuaian</b>".
            </li>
            <li>Jika anda memilih <i>"Penyesuaian"</i> maka akan muncul field "<b>Pendapatan
                    yang Disesuaikan</b>". Field tersebut tidak akan muncul jika anda memilih
                <i>"Pendapatan Baru"</i>. Anda dapat memilih Nomor Transaksi dari pendapatan
                yang ingin anda sesuaikan pada field tersebut. Anda juga dapat mencari Nomor
                Transaksi pendapatan yang ingin disesuaikan dengan mengetiknya pada field
                "<b><i>Search</i></b>" dalam field tersebut.
            </li>
            <li>Disebelah kanan field <i>"Pendapatan yang Disesuaikan"</i> terdapat tombol
                "<b>Lihat Detail</b>" untuk melihat detail dari Nomor Transaksi Penyesuaian
                yang telah dipilih.
            </li>
            <li>Pilih tanggal transaksi pendapatan pada field "<b>Tanggal Transaksi</b>".
            </li>
            ...
            <li>Pilih penerimaan pendapatan pada field "<b>Dibayar Ke</b>". Terdapat
                2 (<i>dua</i>) jenis pilihan pada field tersebut. Pilih salah satu dari
            ...
            <li>Jika anda memilih "<i>Kas</i>" maka akan muncul field "<b>Rekening Kas</b>".
                ...
                rekening kas yang menjadi "<i>Post</i>" dari penerimaan pendapatan yang anda
                lakukan.
            </li>
            <li>Jika anda memilih "<i>Bank</i>" maka akan muncul field "<b>Rekening Bank</b>".
                ...
                Bank yang menjadi "<i>Post</i>" dari penerimaan pendapatan yang anda lakukan.
            </li>
            ...
            <li>Masukkan File nota pendapatan pada field "<b>Nota Transaksi</b>" dengan cara
            ...
            <li>Setelah selesai mengisi keterangan langkah selanjutnya adalah mengisi
                ...
                <b>Nama</b>, <b>QTY (<i>Kuantitas</i>)</b>, <b>Satuan</b>, <b>Harga Satuan</b>,
                <b>Total</b>, <b>Aksi</b> yang berisi tombol <b>Hapus Baris</b>, dan tombol
                <b>Tambah Baris</b>.
            </li>
            <li>Masukkan keterangan detail pendapatan pada field "<i>Nama</i>".</li>
            <li>Setelah itu, masukkan jumlah atau kuantitas pendapatan pada field "<i>QTY</i>".
            </li>
            <li>Pilih satuan per kuantitas pada field "<i>Satuan</i>".</li>
            <li>Masukkan harga satuan pendapatan pada field "<i>Harga Satuan</i>".</li>
            <li>Setelah memasukkan harga satuan, total transaksi akan muncul secara otomatis
                pada field "<i>Total</i>". Begitupun juga <b>Total pendapatan</b> akan muncul
                secara otomatis.</li>
