                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form" action="{{ route('mdu-berita.store') }}" method="POST"
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="date"
                                                    ...
                                                    placeholder="Masukkan tanggal berita." name="tgl_berita">
                                                @error('tgl_berita')
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="isi_berita" id="defaultNews" cols="30"
                                                    class="form-control @error('isi_berita') is-invalid @enderror" rows="10"></textarea>
                                                @error('isi_berita')
                                                    <span class="invalid-feedback" role="alert">
                                                        {{ $message }}
                                                    </span>
