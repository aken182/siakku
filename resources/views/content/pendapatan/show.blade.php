        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <h5 class="text-success">Detail Pendapatan</h5>
                            ...
                            <table class="table table-flush-spacing-sm table-bordered">
                                ...
                                <tbody>
                                    @foreach ($transaksis as $transaksi)
                                        <tr>
                                            <td>{{ $transaksi->nama_pendapatan }}</td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="card-body">
                        ...
                        <img class="img-fluid d-flex mx-auto my-4" src="{{ asset('storage/nota-pendapatan/' . $nota) }}"
                            alt="Card image cap">
