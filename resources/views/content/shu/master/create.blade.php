                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form" action="{{ $routeStore }}" method="POST">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    placeholder="Masukkan nama alokasi dana." name="nama">
                                                @error('nama')
                                                ...
                                                <input type="hidden" name="nilai_bagi" value="0" />
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                                ...
                                                <div class="col-3">
                                                    <div class="input-group mb-3">
                                                        <input type="number" step="0.25" class="form-control"
                                                            placeholder="ex.30" id="persen" name="persen">
                                                        <span
