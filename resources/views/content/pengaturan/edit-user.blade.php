...
@section('content')
    ...
    <div class="page-content">
        <section id="multiple-column-form">
            <div class="card">
                <form class="card-body" action="{{ route($routeUpdate, $user->id) }}" method="post">
                    @csrf
                    @method('PATCH')
                    <div class="row mb-3">
                        <div class="col">
                            ...
                            <input type="hidden" name="id_anggota" value="{{ $user->id_anggota }}" class="form-control"
                                readonly>
                            @error('id_anggota')
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <input class="form-control @error('username') is-invalid @enderror" id="username"
                                name="username" type="text" value="{{ $user->username }}" placeholder="ex: John12">
                            @error('username')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            @enderror"
                                name="role">
                                <option value="{{ $userRole->role_id }}" selected>{{ $userRole->roles->name }}</option>
