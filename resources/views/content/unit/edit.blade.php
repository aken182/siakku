                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form" action="{{ route('mdu-unit.update', $unit->id_unit) }}" method="POST">
                                    @csrf
                                    @method('PATCH')
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    placeholder="ex. LRTK-" value="{{ $unit->kode_unit }}" name="kode_unit"
                                                    readonly>
                                                @error('kode_unit')
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    placeholder="ex. Larantuka" name="nama" value="{{ $unit->nama }}">
                                                @error('nama')
                                                    <span class="invalid-feedback" role="alert">
                                                        {{ $message }}
                                                    </span>
