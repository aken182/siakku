                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form" action="{{ route('mdu-jabatan.update', $jabatan->id_jabatan) }}"
                                    method="POST">
                                    @csrf
                                    @method('PATCH')
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <select name="id_anggota"
                                                    ...
                                                    <option value="{{ $jabatan->id_anggota }}" selected>
                                                        {{ $jabatan->anggota->nama }}</option>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <select name="jabatan"
                                                    ...
                                                    <option value="{{ $jabatan->jabatan }}" selected>{{ $jabatan->jabatan }}
                                                    </option>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <select name="status"
                                                    ...
                                                    <option value="{{ $jabatan->status }}" selected>{{ $jabatan->status }}
                                                    </option>
