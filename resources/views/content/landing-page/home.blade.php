            ...
            <div class="container">
                <div class="row justify-content-center text-center mb-5" data-aos="fade">
                    <div class="col-md-6 mb-5">
                        <img src="{{ asset('assets/landing-page') }}/img/undraw_svg_1.svg" alt="Image" class="img-fluid">
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6" data-aos="fade-left">
                        <img src="{{ asset('assets/landing-page') }}/img/undraw_svg_2.svg" alt="Image"
                            class="img-fluid">
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6" data-aos="fade-right">
                        <img src="{{ asset('assets/landing-page') }}/img/undraw_svg_3.svg" alt="Image"
                            class="img-fluid">
                    </div>
                </div>
            </div>
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="review text-center">
                                        ...
                                        <p class="review-user">
                                            <img src="{{ asset('assets/landing-page') }}/img/person_1.jpg" alt="Image"
                                ...
                                <div class="swiper-slide">
                                    <div class="review text-center">
                                        ...
                                        <p class="review-user">
                                            <img src="{{ asset('assets/landing-page') }}/img/person_2.jpg" alt="Image"
                                                class="img-fluid rounded-circle mb-3">
                                            <span class="d-block">
                                ...
                                <div class="swiper-slide">
                                    <div class="review text-center">
                                        ...
                                        <p class="review-user">
                                            <img src="{{ asset('assets/landing-page') }}/img/person_3.jpg" alt="Image"
                                                class="img-fluid rounded-circle mb-3">
                                            <span class="d-block">
