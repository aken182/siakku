                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form" action="{{ route('pp-pengajuan.update', $pengajuan->id_pengajuan) }}"
                                    method="POST">
                                    @csrf
                                    @method('PATCH')
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <select name="id_anggota"
                                                    ...
                                                    id="id_anggota">
                                                    <option value="{{ $pengajuan->id_anggota }}" selected>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="gaji_perbulan" value="{{ buatrp($pengajuan->gaji_perbulan) }}"
                                                    onKeyUp="hitung()">
                                                @error('gaji_perbulan')
                                                    <span class="invalid-feedback" role="alert">
                                                        {{ $message }}
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="potongan_perbulan" name="potongan_perbulan"
                                                    value="{{ buatrp($pengajuan->potongan_perbulan) }}" onKeyUp="hitung()">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    placeholder="Masukkan nominal cicilan lain/bulan."
                                                    value="{{ buatrp($pengajuan->cicilan_perbulan) }}"
                                                    id="cicilan_perbulan" name="cicilan_perbulan" onKeyUp="hitung()">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    placeholder="Masukkan nominal biaya hidup/bulan."
                                                    value="{{ buatrp($pengajuan->biaya_perbulan) }}" id="biaya_perbulan"
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    placeholder="Sisa penghasilan/bulan."
                                                    value="{{ buatrp($pengajuan->sisa_penghasilan) }}"
                                                    id="sisa_penghasilan" name="sisa_penghasilan" readonly>
                                                ...
                                                <div class="col-4">
                                                    <div class="input-group mb-3">
                                                        <input type="number" step="0.25"
                                                            ...
                                                            placeholder="ex.100" id="perkiraan"
                                                            value="{{ $pengajuan->perkiraan }}" name="perkiraan"
                                                            onKeyUp="hitung()">
                                                        @error('perkiraan')
                                                            <span class="invalid-feedback" role="alert">
                                                                {{ $message }}
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    placeholder="Kemampuan Bayar Cicilan/bulan."
                                                    value="{{ buatrp($pengajuan->kemampuan_bayar) }}"
                                                    id="kemampuan_bayar" name="kemampuan_bayar" readonly>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ buatrp($pengajuan->jumlah_pinjaman) }}" onKeyUp="hitung()">
                                                ...
                                                <div class="col-4">
                                                    <div class="input-group mb-3">
                                                        <input type="number" step="0.25"
                                                            ...
                                                            placeholder="ex.12" id="jangka_waktu"
                                                            value="{{ $pengajuan->jangka_waktu }}" name="jangka_waktu"
                                                            onKeyUp="hitung()">
                                                        @error('jangka_waktu')
                                                            <span class="invalid-feedback" role="alert">
                                                                {{ $message }}
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    placeholder="Masukkan nominal asuransi."
                                                    value="{{ buatrp($pengajuan->asuransi) }}" id="asuransi"
                                                ...
                                                <div class="col-3">
                                                    <div class="input-group mb-3">
                                                        <input type="number" step="0.25"
                                                            ...
                                                            value="{{ $pengajuan->bunga }}" id="bunga"
                                                            name="bunga" onKeyUp="hitung()" readonly>
                                                        @error('bunga')
                                                            <span class="invalid-feedback" role="alert">
                                                                {{ $message }}
                                                            </span>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    placeholder="Kapitalisasi (5% dari pinjaman)."
                                                    value="{{ buatrp($pengajuan->kapitalisasi) }}" id="kapitalisasi"
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    placeholder="Total angsuran/bulan."
                                                    value="{{ buatrp($pengajuan->total_angsuran) }}" id="total_angsuran"
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    placeholder="Angsuran pokok/bulan."
                                                    value="{{ buatrp($pengajuan->angsuran_pokok) }}" id="angsuran_pokok"
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    placeholder="Angsuran bunga/bulan."
                                                    value="{{ buatrp($pengajuan->angsuran_bunga) }}" id="angsuran_bunga"
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    placeholder="Total pinjaman yang diterima."
                                                    value="{{ buatrp($pengajuan->total_pinjaman) }}" id="total_pinjaman"
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="keterangan" id="keterangan" cols="30" rows="3"
                                                    class="form-control @error('keterangan') is-invalid @enderror" placeholder="Masukkan Keterangan.">{{ $pengajuan->keterangan }}</textarea>
                                                @error('keterangan')
                                                    <span class="invalid-feedback" role="alert">
                                                        {{ $message }}
                                                    </span>
