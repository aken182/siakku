                            ...
                            <div class="card-body">
                                <form class="form" action="{{ route('mdu-coa.store') }}" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="kode"
                                                    ...
                                                    placeholder="Masukkan Kode Akun" value="{{ old('kode') }}">
                                                @error('kode')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nama"
                                                    ...
                                                    placeholder="Masukkan Nama Akun" value="{{ old('nama') }}">
                                                @error('nama')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="subkategori" class="text-primary">Sub Kategori</label>
