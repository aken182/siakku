                            ...
                            <div class="card-body">
                                ...
                                <div class="row mt-3">
                                    <div class="col">
                                        ...
                                        <div class="row mb-3 pemberi-hutang">
                                            <div class="col">
                                                <label for="id_penyedia" class="form-label  text-primary">Pemberi
                                                    Pinjaman</label>
                                                ...
                                                @enderror
                                                <small class="text-primary"><i>Note : Jika nama pemberi pinjaman belum ada
                                                        silakan mengisi datanya di master data vendor !</i></small>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col mb-3">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="row akun-belanja">
                                            <div class="col mb-3">
                                                <label for="id_belanja" class="form-label text-primary">Akun
                                                    Belanja</label>
                                                <select id="id_belanja" name="id_belanja"
                                                    class="form-select choices @error('id_belanja') is-invalid @enderror">
                                                    <option value="" selected>Pilih Kode - Nama Akun</option>
                                                    @foreach ($coaBelanja as $c)
                                        ...
                                        <div class="row akun-penerima">
                                            <div class="col mb-3">
                                                <label for="nameBackdrop" class="form-label text-primary">Akun
                                                    Penerima</label>
                                                <select id="id_penerima" name="id_penerima"
                                                    class="form-select choices @error('id_penerima') is-invalid @enderror">
                                                    <option value="" selected>Pilih Kode - Nama Akun</option>
                                                    @foreach ($coaPenerimaHutang as $p)
                                        ...
                                        <div class="row">
                                            <div class="col mb-3">
                                                <label for="tpk" class="form-label text-primary">TPK</label>
                                                <select name="tpk"
                                                    class="form-select choices @error('tpk') is-invalid @enderror">
                                                    <option value="" selected>Pilih TPK</option>
                                                    <option value="Larantuka">TPK Larantuka</option>
                                                    <option value="Waiwerang">TPK Waiwerang</option>
                                                    <option value="Pasar Baru">TPK Pasar Baru</option>
                                                </select>
                                                @error('tpk')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
...
@section('pageScript')
    ...
    <script src="{{ asset('assets/admin') }}/js/siakku-custom/belanja.js"></script>
    <script src="{{ asset('assets/admin') }}/js/siakku-custom/penyesuaian-belanja.js"></script>
