...
Route::group(['middleware' => ['permission:master-inventaris-sp']], function () {
...
Route::group(['middleware' => ['permission:master-inventaris-eceran-sp']], function () {
...
Route::group(['middleware' => ['permission:master-simpanan']], function () {
...
Route::group(['middleware' => ['permission:master-vendor-sp']], function () {
...
Route::group(['middleware' => ['permission:pinjaman-unit-sp-pengajuan-view']], function () {
...
Route::group(['middleware' => ['permission:pinjaman-unit-sp-pengajuan-transaction']], function () {
      Route::controller(PengajuanPinjamanController::class)->group(function () {
