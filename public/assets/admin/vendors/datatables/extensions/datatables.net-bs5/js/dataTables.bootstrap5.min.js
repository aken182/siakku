...
!function (t) {
      ...
      "function" == typeof define && define.amd ? define(["jquery", "datatables.net"], function (e) {
            ...
            "undefined" == typeof window ? module.exports = function (e, a) {
                  ...
                  : (r(window, n),
                        module.exports = t(n, window, window.document))) : t(jQuery, window, document)
}(function (x, e, r, o) {
      "use strict";
      ...
      return x.extend(!0, i.defaults, {
            ...
            i.ext.renderer.pageButton.bootstrap = function (d, e, s, a, l, c) {
                  ...
                  var p, f, t, b = new i.Api(d), m = d.oClasses, g = d.oLanguage.oPaginate, w = d.oLanguage.oAria.paginate || {}, e = x(e);
                  try {
