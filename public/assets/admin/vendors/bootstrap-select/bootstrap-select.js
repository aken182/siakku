            ...
            var e = {
                  1936: function () {
                        !function (e) {
                              ...
                              function v(e) {
                                    for (var t, i = [], s = e || m.call(this), n = 0, o = s.length; n < o; n++)
                              ...
                              var C, O, A, T, z, D = (C = {
                                    ...
                                    ,
                                    A = "(?:" + Object.keys(C).join("|") + ")",
                                    T = RegExp(A),
                                    z = RegExp(A, "g"),
                                    function (e) {
                                          return e = null == e ? "" : "" + e,
                                                T.test(e) ? e.replace(z, O) : e
                                    }
                              ), L = {
                                    32: " ",
                                    48: "0",
                              ...
                              j.selectedOption = j.option.cloneNode(!1),
                                    j.selectedOption.setAttribute("selected", !0),
                                    ...
                                    , _ = {
                                          ...
                                          text: function (e, t) {
                                                ...
                                                if (e.content)
                                                      ...
                                                      if (n.textContent = e.text,
                                                            ...
                                                            (s = (!0 === t ? j.i : j.span).cloneNode(!1)).className = this.options.iconBase + " " + e.icon,
                                                                  j.fragment.appendChild(s),
                                                                  j.fragment.appendChild(o)
                                                      }
                                                      e.subtext && ((i = j.subtext.cloneNode(!1)).textContent = e.subtext,
                                                            n.appendChild(i))
                                                }
                                                if (!0 === t)
                                                      for (; n.childNodes.length > 0;)
                                                            j.fragment.appendChild(n.childNodes[0]);
                                                else
                                          ...
                                          label: function (e) {
                                                ...
                                                if (s.innerHTML = e.display,
                                                      ...
                                                      (i = j.span.cloneNode(!1)).className = this.options.iconBase + " " + e.icon,
                                                            j.fragment.appendChild(i),
                                                            j.fragment.appendChild(n)
                                                }
                                                return e.subtext && ((t = j.subtext.cloneNode(!1)).textContent = e.subtext,
                                                      s.appendChild(t)),
                                                      j.fragment.appendChild(s),
                                                      j.fragment
                                          }
                              ...
                              function G(e, t) {
                                    e.length || (j.noResults.innerHTML = this.options.noneResultsText.replace("{0}", '"' + D(t) + '"'),
                              ...
                              function Q(i) {
                                    ...
                                    if (M.major >= "4") {
                                          ...
                                          for (var r = 0; r < l.length; r++)
                                                i = l[r],
                                                      K.DEFAULTS[i.name] = B[i.className]
                                    }
                                    ...
                                    var c = this.each((function () {
                                          ...
                                          if (i.is("select")) {
                                                ...
                                                if (r.title && (r.placeholder = r.title),
                                                      ...
                                                      if (r)
                                                            for (var c in r)
                                                                  Object.prototype.hasOwnProperty.call(r, c) && (l.options[c] = r[c])
                                                } else {
                                                      var d = i.data();
                                                      for (var h in d)
                                                      ...
                                                      p.template = e.extend({}, K.DEFAULTS.template, e.fn.selectpicker.defaults ? e.fn.selectpicker.defaults.template : {}, d.template, r.template),
                                                            p.source = e.extend({}, K.DEFAULTS.source, e.fn.selectpicker.defaults ? e.fn.selectpicker.defaults.source : {}, r.source),
                                                            i.data("selectpicker", l = new K(this, p))
                                                }
                                    ...
                                    K.prototype = {
                                          ...
                                          init: function () {
                                                ...
                                                P++,
                                                      ...
                                                      !0 === this.options.dropdownAlignRight && this.$menu[0].classList.add(B.MENURIGHT),
                                                      void 0 !== i && this.$button.attr("data-id", i),
                                                      this.checkDisabled(),
                                                      this.clickListener(),
                                                      M.major > 4 && (this.dropdown = new N(this.$button[0])),
                                                      this.options.liveSearch ? (this.liveSearchListener(),
                                                            this.focusedParent = this.$searchbox[0]) : this.focusedParent = this.$menuInner[0],
                                                      this.setStyle(),
                                                      this.setWidth(),
                                                      this.options.container ? this.selectPosition() : this.$element.on("hide" + W, (function () {
                                                            if (t.isVirtual()) {
                                                                  var e = t.$menuInner[0]
                                                      ...
                                                      s.hasAttribute("required") && this.$element.on("invalid" + W, (function () {
                                                            t.$button[0].classList.add("bs-invalid"),
                                                                  t.$element.on("shown" + W + ".invalid", (function () {
                                          ...
                                          createDropdown: function () {
                                                ...
                                                var o, l = "", r = "", a = "", c = "", d = "";
                                                return this.options.header && (l = '<div class="' + B.POPOVERHEADER + '"><button type="button" class="close" aria-hidden="true">&times;</button>' + this.options.header + "</div>"),
                                                      this.options.liveSearch && (r = '<div class="bs-searchbox"><input type="search" class="form-control" autocomplete="off"' + (null === this.options.liveSearchPlaceholder ? "" : ' placeholder="' + D(this.options.liveSearchPlaceholder) + '"') + ' role="combobox" aria-label="Search" aria-controls="' + this.selectId + '" aria-autocomplete="list"></div>'),
                                          ...
                                          createView: function (t, i, s) {
                                                ...
                                                function h(e, i) {
                                                      var s, o, l, a, c, d, p, u, f, m, v = n.selectpicker.current.data.length, g = [], b = !0, w = n.isVirtual();
                                                      ...
                                                      if (void 0 === c && (c = 0),
                                                            ...
                                                            n.selectpicker.view.position1 = !1 === w ? v : Math.min(v, g[a][1]) || 0,
                                                            ...
                                                            if (u = n.selectpicker.view.visibleElements ? n.selectpicker.view.visibleElements.slice() : [],
                                                                  ...
                                                                  if (n.options.sanitize && O.length && r(O, n.options.whiteList, n.options.sanitizeFn),
                                          ...
                                          buildList: function (e, t) {
                                                ...
                                                !i.options.showTick && !i.multiple || j.checkMark.parentNode || (j.checkMark.className = this.options.iconBase + " " + i.options.tickIcon + " check-mark",
                                          ...
                                          render: function (e) {
                                                var t, i, s = this, n = this.$element[0], o = this.setPlaceholder() && 0 === n.selectedIndex, l = m.call(this), a = l.length, c = v.call(this, l), d = this.$button[0], h = d.querySelector(".filter-option-inner-inner"), p = document.createTextNode(this.options.multipleSeparator), u = j.fragment.cloneNode(!1), f = !1;
                                                if (this.options.source.data && e && (l.map((function e(t) {
                                                      ...
                                                      d.classList.toggle("bs-placeholder", s.multiple ? !a : !c && 0 !== c),
                                                      s.multiple || 1 !== l.length || (s.selectpicker.view.displayedValue = c),
                                                      "static" === this.options.selectedTextFormat)
                                                      u = _.text.call(this, {
                                                            text: this.options.placeholder
                                                      }, !0);
                                                else if ((t = this.multiple && -1 !== this.options.selectedTextFormat.indexOf("count") && a > 0) && (t = (i = this.options.selectedTextFormat.split(">")).length > 1 && a > i[1] || 1 === i.length && a >= 2),
                                                      !1 === t) {
                                                      if (!o) {
                                                            for (var g = 0; g < a && g < 50; g++) {
                                                                  var b = l[g]
                                                                        , w = {};
                                                                  b && (this.multiple && g > 0 && u.appendChild(p.cloneNode(!1)),
                                                                        b.title ? w.text = b.title : b.content && s.options.showContent ? (w.content = b.content.toString(),
                                                                              f = !0) : (s.options.showIcon && (w.icon = b.icon),
                                                                                    ...
                                                                                    w.text = b.text.trim()),
                                                                        u.appendChild(_.text.call(this, w, !0)))
                                                            }
                                                ...
                                                if (u.childNodes.length || (u = _.text.call(this, {
                                                      ...
                                                      this.options.sanitize && f && r([u], s.options.whiteList, s.options.sanitizeFn),
                                                      h.innerHTML = "",
                                                      h.appendChild(u),
                                          ...
                                          liHeight: function (t) {
                                                if (t || !1 !== this.options.size && !Object.keys(this.sizeInfo).length) {
                                                      var i, s = j.div.cloneNode(!1), n = j.div.cloneNode(!1), o = j.div.cloneNode(!1), l = document.createElement("ul"), r = j.li.cloneNode(!1), a = j.li.cloneNode(!1), c = j.a.cloneNode(!1), d = j.span.cloneNode(!1), h = this.options.header && this.$menu.find("." + B.POPOVERHEADER).length > 0 ? this.$menu.find("." + B.POPOVERHEADER)[0].cloneNode(!0) : null, p = this.options.liveSearch ? j.div.cloneNode(!1) : null, u = this.options.actionsBox && this.multiple && this.$menu.find(".bs-actionsbox").length > 0 ? this.$menu.find(".bs-actionsbox")[0].cloneNode(!0) : null, f = this.options.doneButton && this.multiple && this.$menu.find(".bs-donebutton").length > 0 ? this.$menu.find(".bs-donebutton")[0].cloneNode(!0) : null, m = this.$element[0].options[0];
                                                      if (this.sizeInfo.selectWidth = this.$newElement[0].offsetWidth,
                                                            ...
                                                            n.className = B.MENU + " " + B.SHOW,
                                                            o.className = "inner " + B.SHOW,
                                                            l.className = B.MENU + " inner " + (M.major >= "4" ? B.SHOW : ""),
                                                            r.className = B.DIVIDER,
                                                      ...
                                                      var w, k = i.offsetHeight, y = a ? a.offsetHeight : 0, x = h ? h.offsetHeight : 0, E = p ? p.offsetHeight : 0, $ = u ? u.offsetHeight : 0, S = f ? f.offsetHeight : 0, C = e(r).outerHeight(!0), O = window.getComputedStyle(n), A = n.offsetWidth, T = {
                                                      ...
                                                      o.style.overflowY = "scroll",
                                                            ...
                                                            this.sizeInfo.dropdownHeaderHeight = y,
                                          ...
                                          setMenuSize: function (e) {
                                                ...
                                                if (this.options.dropupAuto && (r = d * this.selectpicker.current.data.length + v.vert,
                                                      ...
                                                      this.$newElement.toggleClass(B.DROPUP, a),
                                                      ...
                                                      n = this.selectpicker.current.data.length > 3 ? 3 * this.sizeInfo.liHeight + this.sizeInfo.menuExtras.vert - 2 : 0,
                                                            ...
                                                            this.$newElement.hasClass(B.DROPUP) && (i = this.sizeInfo.selectOffsetTop - this.sizeInfo.menuExtras.vert),
                                                            o = i,
                                                            t = i - h - p - u - f - v.vert;
                                                ...
                                                this.$menu.css({
                                                      ...
                                                      "auto" === this.options.dropdownAlignRight && this.$menu.toggleClass(B.MENURIGHT, this.sizeInfo.selectOffsetLeft > this.sizeInfo.selectOffsetRight && this.sizeInfo.selectOffsetRight < this.sizeInfo.totalMenuWidth - c),
                                          ...
                                          setWidth: function () {
                                                ...
                                                "auto" === this.options.width ? requestAnimationFrame((function () {
                                                      e.$menu.css("min-width", "0"),
                                                            e.$element.on("loaded" + W, (function () {
                                                                  e.liHeight(),
                                                                        e.setMenuSize();
                                          ...
                                          selectPosition: function () {
                                                ...
                                                var t, i, s, n = this, o = e(this.options.container), l = function (l) {
                                                      ...
                                                      n.$bsContainer.addClass(l.attr("class").replace(/form-control|fit-width/gi, "")).toggleClass(B.DROPUP, l.hasClass(B.DROPUP)),
                                                            t = l.offset(),
                                                            o.is("body") ? i = {
                                                                  top: 0,
                                                                  left: 0
                                                            ...
                                                            (M.major < 4 || "static" === a) && (r.top = t.top - i.top + s,
                                                ...
                                                this.$button.on("click.bs.dropdown.data-api", (function () {
                                                      n.isDisabled() || (l(n.$newElement),
                                                            n.$bsContainer.appendTo(n.options.container).toggleClass(B.SHOW, !n.$button.hasClass(B.SHOW)).append(n.$menu))
                                                }
                                                )),
                                          ...
                                          setDisabled: function (e) {
                                                ...
                                                s && (t = s.firstChild,
                                                      s.classList.toggle(B.DISABLED, i),
                                                      t && (M.major >= "4" && t.classList.toggle(B.DISABLED, i),
                                          ...
                                          checkDisabled: function () {
                                                this.isDisabled() ? (this.$newElement[0].classList.add(B.DISABLED),
                                                      this.$button.addClass(B.DISABLED).attr("aria-disabled", !0)) : this.$button[0].classList.contains(B.DISABLED) && (this.$newElement[0].classList.remove(B.DISABLED),
                                                            this.$button.removeClass(B.DISABLED).attr("aria-disabled", !1))
                                          },
                                          clickListener: function () {
                                                ...
                                                i.data("spaceSelect", !1),
                                                      ...
                                                      this.$newElement.on("show.bs.dropdown", (function () {
                                                            t.dropdown || "4" !== M.major || (t.dropdown = t.$button.data("bs.dropdown"),
                                                                  ...
                                                                  /MSIE|Trident/.test(window.navigator.userAgent) && (i = document.elementFromPoint(e.clientX, e.clientY)),
                                                                        i !== s && i.parentElement !== s || (e.stopImmediatePropagation(),
                                                                              function (e) {
                                                                                    ...
                                                                                    t.$newElement.hasClass(B.SHOW) && (t.options.liveSearch && t.$searchbox.trigger("focus"),
                                                                                          t.createView(!1))
                                                                              }())
                                                            }
                                                      ...
                                                      this.$menuInner.on("click", "li a", (function (i, s) {
                                                            ...
                                                            if (t.multiple && 1 !== t.options.maxOptions && i.stopPropagation(),
                                                                  i.preventDefault(),
                                                                  !t.isDisabled() && !n.parent().hasClass(B.DISABLED)) {
                                                                  var f = r.option
                                                                        , g = e(f)
                                                                        , w = f.selected
                                                                                    ...
                                                                                    if (E && 1 === E)
                                                                                          ...
                                                                                          D[2] && (L = L.replace("{var}", D[2][E > 1 ? 0 : 1]),
                                                                                                ...
                                                                                                E && S && (H.append(e("<div>" + L + "</div>")),
                                                                                                      u = !1,
                                                                                                      t.$element.trigger("maxReached" + W)),
                                                                                                $ && A && (H.append(e("<div>" + N + "</div>")),
                                                                                                      u = !1,
                                                                                                      t.$element.trigger("maxReachedGrp" + W)),
                                                                                                setTimeout((function () {
                                                                                                      t.setSelected(r, !1)
                                                                                                }
                                                                                                ), 10),
                                                                  ...
                                                                  t.options.source.data && t.$element[0].appendChild(t.selectpicker.main.optionQueue),
                                                                        ...
                                                                        u && (t.multiple || d !== o.selectedIndex) && (b = [f.index, g.prop("selected"), c],
                                                                              t.$element.triggerNative("change"))
                                                            }
                                                      }
                                                      )),
                                          ...
                                          val: function (e) {
                                                ...
                                                if (void 0 !== e) {
                                                      ...
                                                      if (this.selectpicker.main.data.filter((function (t) {
                                                            ...
                                                            this.$element.trigger("changed" + W, b),
                                          ...
                                          toggle: function (e, t) {
                                                ...
                                                (e = e || window.event) && e.stopPropagation(),
                                                      !1 === s && (i = this.$newElement[0].classList.contains(B.SHOW),
                                                            s = !0 === t && !1 === i || !1 === t && !0 === i),
                                          ...
                                          keydown: function (t) {
                                                var i, s, n, o, l, r = e(this), a = r.hasClass("dropdown-toggle"), c = (a ? r.closest(".dropdown") : r.closest(R.MENU)).data("this"), d = c.findLis(), h = !1, p = 9 === t.which && !a && !c.options.selectOnTab, u = U.test(t.which) || p, f = c.$menuInner[0].scrollTop, m = !0 === c.isVirtual() ? c.selectpicker.view.position0 : 0;
                                                if (!(t.which >= 112 && t.which <= 123))
                                                      if (!(s = c.$menu.hasClass(B.SHOW)) && (u || t.which >= 48 && t.which <= 57 || t.which >= 96 && t.which <= 105 || t.which >= 65 && t.which <= 90) && (c.$button.trigger("click.bs.dropdown.data-api"),
                                                            ...
                                                            if (27 === t.which && s && (t.preventDefault(),
                                                                  ...
                                                                  -1 !== (i = (n = c.activeElement) ? Array.prototype.indexOf.call(n.parentElement.children, n) : -1) && c.defocusItem(n),
                                                                        38 === t.which ? (-1 !== i && i--,
                                                                              i + m < 0 && (i += d.length),
                                                                              c.selectpicker.view.canHighlight[i + m] || -1 == (i = c.selectpicker.view.canHighlight.slice(0, i + m).lastIndexOf(!0) - m) && (i = d.length - 1)) : (40 === t.which || p) && (++i + m >= c.selectpicker.view.canHighlight.length && (i = c.selectpicker.view.firstHighlightIndex),
                                                                  ...
                                                                  38 === t.which ? 0 === m && i === d.length - 1 ? (c.$menuInner[0].scrollTop = c.$menuInner[0].scrollHeight,
                                                                        v = c.selectpicker.current.elements.length - 1) : (o = c.selectpicker.current.data[v]) && (h = (l = o.position - o.height) < f) : (40 === t.which || p) && (i === c.selectpicker.view.firstHighlightIndex ? (c.$menuInner[0].scrollTop = 0,
                                          ...
                                          refresh: function () {
                                                ...
                                                this.options = i,
                                                      ...
                                                      this.setWidth(),
                                                      this.setSize(!0),
                                                      this.$element.trigger("refreshed" + W)
                                          },
                                          hide: function () {
                                          ...
                                          destroy: function () {
                                                this.$newElement.before(this.$element).remove(),
                                                      ...
                                                      this.$element.off(W).removeData("selectpicker").removeClass("bs-select-hidden selectpicker mobile-device"),
                                                      e(window).off(W + "." + this.selectId)
                                          }
                                    };
