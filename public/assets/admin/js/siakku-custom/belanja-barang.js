                        ...
                        if (transaksi_id != '') {
                              ...
                              $.ajax({
                                    ...
                                    success: function (result) {
                                          ...
                                          html += "</div>";
                                          html += "</div>";
                                          html += "<p><strong>Detail Pengadaan Barang:</strong></p>";
                                          ...
                                          result.details.forEach(function (detail) {
                                                html += "<tr>";
                                                html += "<td>" + detail.barang.kode_barang + "</td>";
                                                html += "<td>" + detail.barang.nama_barang + "</td>";
                                          ...
                                          html += "</tbody>";
                                          html += "</table>";
                                          html += "<p><strong>Jurnal Pengadaan:</strong></p>";
                                          html +=
