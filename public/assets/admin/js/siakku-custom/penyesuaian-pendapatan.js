...
$(document).ready(function () {
      $(function () {
            $('.invoicePenyesuaianPendapatan').each(function (index, element) {
                        ...
                        if (transaksi_id != '') {
                              ...
                              $.ajax({
                                    ...
                                    success: function (result) {
                                          ...
                                          html += "<td class='text-capitalize text-dark' style='text-align: right'>#" + result.transaksi.no_bukti + "</td>";
                                          html += "</tr>";
                                          html += "<tr>";
                                          ...
                                          html += "</div>";
                                          html += "</div>";
                                          html += "<p><strong>Detail Pendapatan:</strong></p>";
                                          ...
                                          result.details.forEach(function (detail) {
                                                html += "<tr>";
                                                html += "<td>" + detail.nama_pendapatan + "</td>";
                                                html += "<td>" + detail.jenis_pendapatan + "</td>";
                                          ...
                                          html += "</tbody>";
                                          html += "</table>";
                                          html += "<p><strong>Jurnal Pendapatan:</strong></p>";
                                          html +=
                                          ...
                                          html += "</table>";
                                          html += "</div>";
                                          $('#detailPendapatan').html(html).show();
                                    },
